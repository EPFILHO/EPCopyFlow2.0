...
void OnTradeTransaction(const MqlTradeTransaction &trans, const MqlTradeRequest &request, const MqlTradeResult &result)
{
   ...
   // Request data - FLATTENAR para evitar bug de serialização de objetos aninhados
   stream_msg["request_action"] = (int)request.action;
   stream_msg["request_order"] = (long)request.order;
   stream_msg["request_symbol"] = request.symbol;  // Sempre enviar símbolo (sem NULL)
   ...
   // Result data - FLATTENAR para evitar bug de serialização de objetos aninhados
